package com.evs.foodexp.driverPkg.adapter.spot.spotfood;
...
public class FoodDataSourceFactory extends DataSource.Factory {
    ...
    public FoodDataSourceFactory(String action, String userId, String userType, String status, String dateBy, AuthStatusListener authListener) {
        this.user_id = userId;
        this.status = status;
    ...
    public DataSource<Integer, OrderModel> create() {
        ...
        FoodDataSource itemDataSource = new FoodDataSource(action,user_id,userType,status,dateBy,authListener);
