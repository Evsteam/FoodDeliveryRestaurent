...
public class ServiceWeeklyEarningPagedAdapter extends PagedListAdapter<BookingModel, ServiceWeeklyEarningPagedAdapter.ItemViewHolder> {

    private Context mCtx;

    public ServiceWeeklyEarningPagedAdapter(Context mCtx) {
        super(DIFF_CALLBACK);
        this.mCtx = mCtx;
    }
