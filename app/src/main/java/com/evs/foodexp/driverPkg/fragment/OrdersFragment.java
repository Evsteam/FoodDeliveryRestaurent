...
public class OrdersFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText(getResources().getString(R.string.speOrder)));
        ...
        CharSequence Titles[] = {getResources().getString(R.string.service), getResources().getString(R.string.foodDelivery),getResources().getString(R.string.ToGet),getString(R.string.speOrder)};
        OrdersFragment.VendorFoodOrdersPagerAdapter adapter = new OrdersFragment.VendorFoodOrdersPagerAdapter(getChildFragmentManager(), Titles, tabLayout.getTabCount());
    ...
    public class VendorFoodOrdersPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                ...
                case 1:
                    return new OrderRequestFood();
                case 2:
                    return new OrderRequestToget();
                case 3:
