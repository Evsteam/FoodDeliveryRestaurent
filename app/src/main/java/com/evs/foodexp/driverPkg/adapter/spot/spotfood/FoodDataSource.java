...
public class FoodDataSource extends PageKeyedDataSource<Integer, OrderModel> {
    ...
    FoodDataSource(String action, String userId, String userType, String status, String dateBy, AuthStatusListener authListener) {
        this.userId = userId;
        this.status = status;
