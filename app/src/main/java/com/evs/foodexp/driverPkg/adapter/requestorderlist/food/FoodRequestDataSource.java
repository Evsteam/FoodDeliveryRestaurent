...
public class FoodRequestDataSource extends PageKeyedDataSource<Integer, RequestModel> {
    ...
    public FoodRequestDataSource(String action, String userId,  AuthStatusListener authListener) {
        this.userId = userId;
        this.action = action;
    ...
    @Override
    public void loadInitial(@NonNull LoadInitialParams<Integer> params, @NonNull final LoadInitialCallback<Integer, RequestModel> callback) {

        RetrofitApiService.getApiService()
                .getFoodRequest(action, userId, String.valueOf(FIRST_PAGE))
                .enqueue(new Callback<ListResponse<RequestModel>>() {
                    @Override
    ...
    @Override
    public void loadBefore(@NonNull final LoadParams<Integer> params, @NonNull final LoadCallback<Integer, RequestModel> callback) {

//        RetrofitApiService.getApiService()
//                .getFoodRequest(action, userId, String.valueOf(params.key))
//                .enqueue(new Callback<ListResponse<RequestModel>>() {
//                    @Override
//                    public void onResponse(Call<ListResponse<RequestModel>> call, Response<ListResponse<RequestModel>> response) {
//                        if (response.isSuccessful()) {
...
//                });
    ...
    @Override
    public void loadAfter(@NonNull final LoadParams<Integer> params, @NonNull final LoadCallback<Integer, RequestModel> callback) {
