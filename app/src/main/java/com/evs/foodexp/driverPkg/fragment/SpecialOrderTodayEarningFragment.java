...
public class SpecialOrderTodayEarningFragment extends Fragment implements AuthStatusListener, AuthMsgListener {
...
//    }
        ...
        if (Global.isOnline(getContext())) {
            viewModel.executeEarning("specialearning",SessionManager.get_user_id(prefs), SessionManager.get_userType(prefs), "Today", this);
            viewModel.apiTogetEarning("specialrequestlist",SessionManager.get_user_id(prefs), "2", SessionManager.get_userType(prefs), "Today", this);
