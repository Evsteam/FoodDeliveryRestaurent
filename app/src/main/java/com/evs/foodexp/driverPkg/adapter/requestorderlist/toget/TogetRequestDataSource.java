...
public class TogetRequestDataSource extends PageKeyedDataSource<Integer, GoGetModel> {
    ...
    TogetRequestDataSource(String action, String userId, String status, String usertype, AuthStatusListener authListener) {
        this.userId = userId;
        this.status = status;
    ...
    public void loadInitial(@NonNull LoadInitialParams<Integer> params, @NonNull final LoadInitialCallback<Integer, GoGetModel> callback) {
        ...
        RetrofitApiService.getApiService()
                .togetRequest(action, userId, String.valueOf(FIRST_PAGE))
...
//        RetrofitApiService.getApiService()
//                .togetRequest(action, userId,String.valueOf(params.key))
//                .enqueue(new Callback<ListResponse<GoGetModel>>() {
//                    @Override
//                    public void onResponse(Call<ListResponse<GoGetModel>> call, Response<ListResponse<GoGetModel>> response) {
//                        if (response.isSuccessful()) {
