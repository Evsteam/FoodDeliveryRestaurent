...
public class ToGetListAdapter extends RecyclerView.Adapter<ToGetListAdapter.MyViewHolder> {
    Context context;
    List<MenuListDto.Data> list1;

    public ToGetListAdapter(Context context, List<MenuListDto.Data> list1) {
