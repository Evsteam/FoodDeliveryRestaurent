...
public class ServiceEarningDataSourceWeekly extends PageKeyedDataSource<Integer, BookingModel> {
    ...
    ServiceEarningDataSourceWeekly(String userId, String userType, String status, String dateBy, AuthStatusListener authListener) {
        this.userId = userId;
        this.status = status;
