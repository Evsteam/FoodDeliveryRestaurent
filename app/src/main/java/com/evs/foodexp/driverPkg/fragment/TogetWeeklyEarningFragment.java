...
public class TogetWeeklyEarningFragment extends Fragment implements AuthStatusListener, AuthMsgListener {
    Button btn_cashOut;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (Global.isOnline(getContext())) {
            viewModel.executeEarning("togetearning",SessionManager.get_user_id(prefs), SessionManager.get_userType(prefs), "Weekly", this);
            viewModel.apiTogetEarningWeekly("gogetlist",SessionManager.get_user_id(prefs), "2", SessionManager.get_userType(prefs), "Weekly", this);
