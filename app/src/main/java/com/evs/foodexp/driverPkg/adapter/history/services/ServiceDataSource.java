...
public class ServiceDataSource extends PageKeyedDataSource<Integer, HistoryModel> {
    ...
    public ServiceDataSource(String action, String userId,String status,String usertype, AuthStatusListener authListener) {
        this.userId = userId;
        this.action = action;
        this.status = status;
