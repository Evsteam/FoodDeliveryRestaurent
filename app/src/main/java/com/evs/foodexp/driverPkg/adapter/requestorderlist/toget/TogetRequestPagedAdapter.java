...
public class TogetRequestPagedAdapter extends PagedListAdapter<GoGetModel, TogetRequestPagedAdapter.ItemViewHolder> {

    private Context mCtx;
    private PagedItemClick<GoGetModel> itemClick;

    public TogetRequestPagedAdapter(Context mCtx, PagedItemClick<GoGetModel> itemClick) {
        super(DIFF_CALLBACK);
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
        ...
        final GoGetModel model = getItem(position);
    ...
    private static DiffUtil.ItemCallback<GoGetModel> DIFF_CALLBACK =
            new DiffUtil.ItemCallback<GoGetModel>() {
                ...
                public boolean areItemsTheSame(GoGetModel oldItem, GoGetModel newItem) {
                    return oldItem.getTogetDriverRequestId().equalsIgnoreCase(newItem.getTogetDriverRequestId());
                }
