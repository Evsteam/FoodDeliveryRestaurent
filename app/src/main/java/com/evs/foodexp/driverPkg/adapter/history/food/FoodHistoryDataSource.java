...
public class FoodHistoryDataSource extends PageKeyedDataSource<Integer, HistoryModel> {
    ...
    public FoodHistoryDataSource(String action, String userId,String status,String usertype, AuthStatusListener authListener) {
        this.userId = userId;
        this.action = action;
