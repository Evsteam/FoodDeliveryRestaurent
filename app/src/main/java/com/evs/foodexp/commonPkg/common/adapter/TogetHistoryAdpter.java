...
public class TogetHistoryAdpter extends RecyclerView.Adapter<TogetHistoryAdpter.myViewHolder> {
    Context mcContext;
    List<HistoryModel> dataList;
    PagedItemClick<HistoryModel> itemClick;

    public TogetHistoryAdpter(Context mContext, List<HistoryModel> dataList , PagedItemClick<HistoryModel> itemClick) {
