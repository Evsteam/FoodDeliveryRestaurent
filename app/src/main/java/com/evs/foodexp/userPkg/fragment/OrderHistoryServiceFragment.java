...
import com.evs.foodexp.driverPkg.adapter.history.services.ServicePagedAdapter;
...
public class OrderHistoryServiceFragment extends Fragment implements PagedItemClick<HistoryModel>,
...
//    ServiceHistoryAdpter adapter;
    ServicePagedAdapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        list=new ArrayList<>();
//        adapter = new ServiceHistoryAdpter(getContext(), list, OrderHistoryServiceFragment.this);
//        historyList.setAdapter(adapter);
        adapter = new ServicePagedAdapter(getContext(),  OrderHistoryServiceFragment.this);


//        if (Global.isOnline(getContext())) {
//            viewModel.apiServiceHistory("bookinglist", SessionManager.get_user_id(prefs),
//                    "", SessionManager.get_userType(prefs), this);
////                    SessionManager.get_userType(prefs), "","" + page, this);
////            viewModel.getTogetList("bookinglist", SessionManager.get_user_id(prefs),
////           .         SessionManager.get_userType(prefs), "","" + page, this);
//
...
//        viewModel.getServiceHistoryist().observe(this, new Observer<PagedList<HistoryModel>>() {
//            @Override
...
//        historyList.setAdapter(adapter);
    ...
    public void pagedmClick(HistoryModel object) {
        Intent intent=new Intent(getActivity(), ServiceJobDetailActivity.class);
