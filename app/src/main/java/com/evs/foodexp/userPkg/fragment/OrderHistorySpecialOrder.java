...
public class OrderHistorySpecialOrder extends Fragment implements PagedItemClick<SpecialOrderModel>,
        AuthListener<ListResponse<SpecialOrderModel>> , AuthStatusListener {
...
//        historyList.setAdapter(adapter);
        adapter = new SpecialRequestPagedAdapter(getContext(), OrderHistorySpecialOrder.this);
...
//        intent.putExtra("togetrequestId", object.getO());
//        startActivity(intent);
    ...
    @Override
    public void onSuccess(LiveData<ListResponse<SpecialOrderModel>> data) {
        progress.dismiss();
...
//        } else Global.msgDialog(getActivity(), data.getValue().getMsg());
    ...
    public void onResume() {
        super.onResume();
//        if (Global.isOnline(getContext())) {
//            viewModel.apiSpecialOrder("specialrequestlist", SessionManager.get_user_id(prefs),
//                    "", SessionManager.get_userType(prefs), this);
//        } else Global.showDialog(getActivity());
//        viewModel.getSpecialorderList().observe(this, new Observer<PagedList<SpecialOrderModel>>() {
//            @Override
//            public void onChanged(PagedList<SpecialOrderModel> historyModels) {
//                adapter.submitList(historyModels);
//            }
//        });
//        historyList.setAdapter(adapter);
