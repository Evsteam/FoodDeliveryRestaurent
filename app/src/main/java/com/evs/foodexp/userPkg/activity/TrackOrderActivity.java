...
public class TrackOrderActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    String driverId, bookingId, dropLat,
            dropLongs, dropAddress, amount , driverName;
//    String items,pickLong,pickUplat,restName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utills.StatusBarColour(TrackOrderActivity.this);
        ...
        progress = new LoaderProgress(TrackOrderActivity.this);
...
//            pickLong = bundle.getString("pickLong");
...
//        method_getTracking();
    ...
    public void onMapReady(GoogleMap googleMap) {
        this.mMap = googleMap;
        if (Global.GpsEnable(TrackOrderActivity.this)) {

            //            myLocation(new LatLng(gpsTracker.getLatitude(), gpsTracker.getLongitude()));
            method_getTracking();
        } else Global.showGPSDisabledAlertToUser(TrackOrderActivity.this);
    }
                ...
                ChildEventListener childEventListener = new ChildEventListener() {
                    ...
                    public void onChildAdded(DataSnapshot dataSnapshot, String previousChildName) {
                        ...
                        if (Global.validatename(comment.lat)) {
                            ...
                            Global.msgDialogBack(TrackOrderActivity.this, "Your Order is Pending!!!");
                    }
                    ...
                    public void onCancelled(DatabaseError databaseError) {
                        ...
                        Toast.makeText(TrackOrderActivity.this, "Failed to load comments.",
...
//                        if (Global.validatename(pickUplat) || Global.validatename(pickLong)) {
//                            String url = getDirectionsUrl(new LatLng(Double.parseDouble(dropLat), Double.parseDouble(dropLongs)), new LatLng(Double.parseDouble(pickUplat), Double.parseDouble(pickLong)));
...
//                        }
    ...
    private void trakingAdress(String userlat, String userlong,
        ...
        if (Global.validatename(userlat) || Global.validatename(userlong)) {
            String url = getDirectionsUrl(new LatLng(Double.parseDouble(drivlat), Double.parseDouble(drivelong)), new LatLng(Double.parseDouble(userlat), Double.parseDouble(userlong)));
            DownloadTask downloadTask = new DownloadTask();
            downloadTask.execute(url);

//            mMap.addMarker(new MarkerOptions()
//                    .position(new LatLng(Double.parseDouble(reslat), Double.parseDouble(restlong)))
//                    .icon(BitmapDescriptorFactory.fromResource(R.drawable.marker_red))
//                    .title(restName)).showInfoWindow();
