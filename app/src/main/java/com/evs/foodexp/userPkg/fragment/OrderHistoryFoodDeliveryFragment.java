...
import com.evs.foodexp.driverPkg.adapter.history.food.FoodHistoryPagedAdapter;
...
public class OrderHistoryFoodDeliveryFragment extends Fragment implements
        PagedItemClick<HistoryModel>,
...
//    HistoryAdpter adapter;
    FoodHistoryPagedAdapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        list=new ArrayList<>();
//        adapter = new HistoryAdpter(getContext(), list, OrderHistoryFoodDeliveryFragment.this);
////        historyList.setAdapter(adapter);
        adapter=new FoodHistoryPagedAdapter(getActivity(),OrderHistoryFoodDeliveryFragment.this);


//        if (Global.isOnline(getContext())) {
////            viewModel.getTogetList("foodorderlist", SessionManager.get_user_id(prefs),
////                    SessionManager.get_userType(prefs),"", "" + page, this);
//            viewModel.apiFoodHistory("foodorderlist", SessionManager.get_user_id(prefs),
...
//        viewModel.getFoodHistoryist().observe(this, new Observer<PagedList<HistoryModel>>() {
//            @Override
