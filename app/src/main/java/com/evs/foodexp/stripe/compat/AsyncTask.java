...
package com.evs.foodexp.stripe.compat;
...
/**
 * API Level 3 compatible AsyncTask
 * - the Default SerialExecutor is implemented as a fixed size, single thread, thread pool executor
 */
...
public abstract class AsyncTask<Params, Progress, Result> {
     ...
     * android.os.Build.VERSION_CODES#HONEYCOMB, it is planned to change this
