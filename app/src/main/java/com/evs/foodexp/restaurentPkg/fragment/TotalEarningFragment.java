...
public class TotalEarningFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.total_earning_layout,container,false);
        Toolbar toolbar = (Toolbar) getActivity().findViewById(R.id.toolbar);
        TextView mTitle = (TextView) toolbar.findViewById(R.id.text_toolbar);
        mTitle.setText("Earning");
        tabLayout = (TabLayout) view.findViewById(R.id.tab_layout_earnings);
        ...
        viewPager = (ViewPager) view.findViewById(R.id.pager_earnings);
    ...
    public class VendorFoodOrdersPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    return new TodayEarningFragment();
                case 1:
