...
public class WeeklyEarningFragment extends Fragment  implements AuthStatusListener, AuthMsgListener {
    Button btn_cashOut;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (Global.isOnline(getContext())) {
            viewModel.executeEarning("getearningfood",SessionManager.get_user_id(prefs), SessionManager.get_userType(prefs),"Weekly",this);
            viewModel.apiEarning(SessionManager.get_user_id(prefs), "4", SessionManager.get_userType(prefs),"Weekly", this);
