...
public class EarningPagedAdapter extends PagedListAdapter<OrderModel, EarningPagedAdapter.ItemViewHolder> {

    private Context mCtx;

    public EarningPagedAdapter(Context mCtx) {
        super(DIFF_CALLBACK);
        this.mCtx = mCtx;
    }
    ...
    public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
        ...
        if (model != null) {
            ...
            holder.tv_itemCount.setText(model.getFoodDetails().size()+" ITEMS");
